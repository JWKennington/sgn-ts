...
def test_sync(capsys): 
    ...
    if mode == 'pad':
        ...
        print_message = "f' duration {self.inbuf.duration} data_is_none {self.inbuf.data is None}'"
    ...
    pipeline.FakeSeriesSrc(
               ...
               internal_link_map = {"trans1:src:H1": "trans1:sink:H1","trans1:src:L1":"trans1:sink:L1","trans1:src:V1":"trans1:sink:V1"},
               mode = mode,
             ).FakeSeriesSink(
               name = "snk1",
               sink_pad_names = ("H1",),
